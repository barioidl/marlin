 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1536, 1536, 1536, 500 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT {(X_MIN_POS + 10), (Y_MIN_POS + 20), (Z_MIN_POS + 5)}
  #define NOZZLE_CLEAN_END_POINT   {(X_MIN_POS + 30), (Y_MIN_POS + 20), (Z_MIN_POS + 5)}
